...
class InvidiousAPI:
    def __init__(self):
        self.all = ast.literal_eval(requests.get('https://raw.githubusercontent.com/myproxy0107-hash/new-yu-yu/refs/heads/main/API.html', headers=getRandomUserAgent(), timeout=(1.0, 0.5)).text)
